...
class Message extends Base {
    constructor(data, client) {
        ...
        switch(this.type) { // REVIEW Should message types 1-5 be here?
            ...
            case MessageTypes.CALL: { // REVIEW Leaving this in until I get clarification why message types 1-5 are still documented
                /*
