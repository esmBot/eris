...
class Client extends EventEmitter {
    ...
    * @arg {Number | Array<String>} [options.gateway.intents] A list of intents, or raw bitmask value describing the intents to subscribe to. Some intents, like `guildPresences` and `guildMembers`, must be enabled on your application's page to be used. By default, all non-privileged intents are enabled.
    ...
    * @arg {Number | Array<String>} [options.intents]  [DEPRECATED] A list of intents, or raw bitmask value describing the intents to subscribe to. Some intents, like `guildPresences` and `guildMembers`, must be enabled on your application's page to be used. By default, all non-privileged intents are enabled. This option has been moved under `options.gateway`
    ...
    */
    async connect() {
        try {
            ...
            if(this.options.shardConcurrency === "auto" && typeof data.session_start_limit !== "undefined" && typeof data.session_start_limit.max_concurrency === "number") {
