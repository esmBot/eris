...
class Client extends EventEmitter {
    ...
    * @arg {Boolean} [options.rest.followRateLimits=true] Whether to acknowledge the ratelimit data sent by Discord. Only disable this option if you're handling ratelimits in some other way.
    ...
    * @arg {Number} [options.rest.port] The port to use for API requests
